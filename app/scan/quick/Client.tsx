  ...
  return (
    <div className="min-h-[100dvh] bg-zinc-50 dark:bg-zinc-950">
      ...
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        <div className="absolute -top-28 -left-24 h-80 w-80 rounded-full bg-gradient-to-br from-violet-400 to-fuchsia-600 opacity-25 blur-3xl" />
        <div className="absolute -bottom-28 -right-24 h-80 w-80 rounded-full bg-gradient-to-br from-teal-400 to-emerald-600 opacity-25 blur-3xl" />
      </div>
      ...
      <main className="relative mx-auto max-w-4xl px-6 py-10">
        ...
        <div className="mb-6 text-sm text-zinc-500 dark:text-zinc-400">
          ...
          / Quick Scan
          <span className="ml-2 text-[10px] text-zinc-400" data-build="QS-LUX-v2" />
        </div>
        ...
        <section className="rounded-3xl border border-zinc-200 bg-white/70 p-6 shadow-sm backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/60">
          ...
          <p className="mt-2 max-w-2xl text-sm text-zinc-600 dark:text-zinc-300">
            See where your personal info might appear online — <b>without creating an account</b>. We only use
            the inputs below for this scan and <b>do not store</b> them.
          </p>
          ...
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            <Link
              href="/ai"
              className="rounded-xl border border-zinc-300 bg-white px-4 py-2 text-sm text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200"
            >
        ...
        <section className="mt-6 space-y-4">
          ...
          {!loading && results && results.length === 0 && (
            <div className="rounded-2xl border border-zinc-200 bg-white/70 p-5 text-sm text-zinc-700 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/60 dark:text-zinc-300">
              ...
              if you already know a broker listing your info.
            </div>
          )}
            ...
            <div className="space-y-3">
              ...
              <div className="rounded-2xl border border-zinc-200 bg-white/70 p-4 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/60">
                <div className="flex flex-wrap items-center justify-between gap-3 text-sm">
                  ...
                  <Link
                    href="/login"
                    className="rounded-xl border border-zinc-300 bg-white px-3 py-1.5 text-sm text-zinc-700 hover:bg-zinc-50 dark:border-zinc-700 dark:bg-zinc-800 dark:text-zinc-200"
                  >
                    Continue & Save Scan
                  </Link>
                </div>
  ...
  return (
    <div className="space-y-2">
      {[...Array(3)].map((_, i) => (
        <div
          key={i}
          className="rounded-2xl border border-zinc-200 bg-white/70 p-4 backdrop-blur-md dark:border-zinc-800 dark:bg-zinc-900/60"
        >
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <a
            ...
            target="_blank"
            rel="noreferrer"
            className="text-base font-medium underline decoration-1 underline-offset-2"
          >
            {hit.broker}
          </a>
