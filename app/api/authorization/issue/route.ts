...
// Creates/updates a DPDP-style authorization record (server-only; SR key used here).
// You can call this after a user completes LoA+KYC upload.
...
export async function POST(req: Request) {
  try {
    ...
    const scopeControllers = Array.isArray(body.scopeControllers) ? body.scopeControllers : null;
