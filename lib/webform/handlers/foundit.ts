// lib/webform/handlers/foundit.ts
import type { WebformHandler, WebformJobInput, WebformResult } from "./types";
import type { Page } from "@playwright/test";

/**
 * Conservative Foundit (ex-Monster India) handler.
 * v1: navigate to privacy/help page, capture artifacts, naive ticket scrape.
 */

const DEFAULT_FOUNDIT_URL = "https://www.foundit.in/seeker/privacypolicy";

const CANDIDATE_URLS: string[] = [
  DEFAULT_FOUNDIT_URL,
  "https://www.foundit.in/seeker/contact-us",
  "https://www.foundit.in/info/terms-of-use",
];
...
async function bestUrl(job: WebformJobInput): Promise<string> {
  ...
  return CANDIDATE_URLS[0] || DEFAULT_FOUNDIT_URL;
}
...
export const FounditHandler: WebformHandler = {
  key: "foundit",
  domains: ["foundit.in"],
  resolveUrl: bestUrl,
  run,
